...
## User stories<a href name="Features">

- __Main menu__<a href name="main_menu">
...
- __Sign in/sign up page__<a href name="signin">
...
- __Profile__<a href name="profile">
...
- __Challenge a friend__<a href name="challenge_a_friend">
...
- __Challenges Page__<a href name="challenges_page">
...
- __Sent challenges__<a href name="sent_challenges">
...
- __Freeplay__<a href name="freeplay">
...
- __Add friend__<a href name="add_friend">
...
- __Game page__<a href name="game_page">
...
# Wireframes<a href name="wireframes">

### adobe XD<a href name="interactive">
...
## How many game boxes??<a href name="challenge1">
...
## Database troubles<a href name="challenge2">
...
## Last guess gone!<a href name="challenge3">
